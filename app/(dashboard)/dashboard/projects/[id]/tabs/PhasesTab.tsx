          ...
          {canEdit && (
            <div className="flex items-center gap-1.5 mt-3 flex-wrap">
              ...
              <button
                ...
                className="ml-auto text-[11px] font-medium text-gray-400 hover:text-[#1C3FAA] transition-colors"
              >
            ...
            <div className="flex items-center gap-3 mt-3 flex-wrap">
              <div className="flex items-center gap-1.5">
                ...
                <input
                  ...
                  className="text-xs border border-gray-200 rounded-lg px-2 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-[#1C3FAA]/20 focus:border-[#1C3FAA] transition-colors"
                />
              </div>
              <div className="flex items-center gap-1.5">
              ...
              {datesChanged && (
                <button
                  ...
                  className="text-xs font-semibold px-2.5 py-1 bg-[#1C3FAA] hover:bg-[#162F82] text-white rounded-lg transition-colors disabled:opacity-50"
                >
                  Save dates
                </button>
              )}
          ...
          {hasCalendarDates && (
            <div className="flex items-center gap-3 mt-2 flex-wrap">
              <a
                ...
                className="flex items-center gap-1 text-[11px] font-medium text-[#1C3FAA] hover:text-[#162F82] transition-colors"
              >
          ...
          {editingNotes && canEdit ? (
            <div className="mt-3 space-y-2">
              <textarea
                ...
                className="w-full text-xs border border-gray-200 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-[#1C3FAA]/20 focus:border-[#1C3FAA] transition-colors resize-none"
              />
              <div className="flex justify-end gap-2">
                ...
                <button
                  ...
                  className="text-xs font-semibold px-3 py-1.5 bg-[#1C3FAA] hover:bg-[#162F82] text-white rounded-lg transition-colors disabled:opacity-50"
                >
                  Save note
                </button>
              </div>
      ...
      <div className="px-5 py-4 flex items-center justify-between gap-4 flex-wrap border-b border-gray-100">
        ...
        <div className="flex items-center gap-2 print:hidden">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 bg-[#1C3FAA] hover:bg-[#162F82] text-white rounded-lg transition-colors"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
